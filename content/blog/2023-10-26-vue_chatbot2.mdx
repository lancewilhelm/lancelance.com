...
<BlogImage src="/img/vue-chatbot/chatbot4.png" width={600} height={0}>
  Console screenshot of the empty message list
</BlogImage>
...
<BlogImage src="/img/vue-chatbot/chatbot5.png" width={600} height={0}>
  Mimic bot, engage!
</BlogImage>
