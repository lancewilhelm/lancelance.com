...
<BlogImage src="/img/causal_attn/attn_diagram.png" width={600} height={0}>
  A diagram of the multi-head attention mechanism and the scaled dot-product
  attention from [Vaswani et al. (2017)](https://arxiv.org/pdf/1706.03762.pdf).
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_et.png" width={600} height={0}>
  Token embeding of Hello World. Each word is represented by a vector of size 3.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_ep.png" width={600} height={0}>
  Position embeding of Hello World. Each word is represented by a vector of size
  3.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_ec.png" width={600} height={0}>
  Combined embedding of Hello World. Each word is represented by a vector of
  size 3.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_qkv.png" width={800} height={0}>
  Queries, keys, and values for our sequence.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_rawattn.png" width={600} height={0}>
  Raw attention values after the dot product.
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/basic_maskedrawattn.png"
  width={600}
  height={0}
>
  Masked raw attention values. Notice that we cannot attend to the target word
  of 'World' from the input word of 'Hello' because we haven't made it that far
  in the sentence yet.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_scaledattn.png" width={600} height={0}>
  Scaled attention values. Now we can see a little intuition here as the softmax
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/basic_scaledattnintuition.png"
  width={600}
  height={0}
>
  Intuition to the scaled attention attention probabilities. Credit to Jinoo
  Baek's blog post for this thought.
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/basic_weightedvalues.png"
  width={600}
  height={0}
>
  Weighted values. We see that the value vector for 'Hello' did not change, but
  the value vector for 'World' did as it is a weighted combination of both value
  vectors.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_loss.png" width={600} height={0}>
  Loss curve for training the basic model.
</BlogImage>
...
<BlogImage src="/img/causal_attn/basic_trained_qkv.png" width={800} height={0}>
  Trained queries, keys, and values.
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/basic_trained_scaledattn.png"
  width={600}
  height={0}
>
  Trained raw attention probabilities.
</BlogImage>
...
<BlogImage src="/img/causal_attn/adv_loss.png" width={600} height={0}>
  Loss curve for training the expanded dataset.
</BlogImage>
...
<BlogImage src="/img/causal_attn/adv_trained_qkv.png" width={800} height={0}>
  Trained queries, keys, and values for the more complicated dataset.
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/adv_trained_rawattn.png"
  width={600}
  height={0}
>
  Trained raw attention matrix for the more complicated dataset.
</BlogImage>
...
<BlogImage
  src="/img/causal_attn/adv_trained_scaledattn.png"
  width={600}
  height={0}
>
  Training attention probabilities/weights for the more complicated dataset.
</BlogImage>
