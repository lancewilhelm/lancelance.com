...
::blog-image
---
imagePath: /img/ppbc/layout visualizer-01.jpg
caption: PPBC wiring design concept. This aided driver programming as it was essential to map the correct LEDs in sequence with their coordinates on the LED array. The code utilized a 2-dimensional array to store the LED indices, so "999" was used for spots in the array where there existed no ball.
width: 640px
---
::

I designed novel font libraries to give the user something more to look at than the single font from the original reference project. It also expanded the font from only digits to characters as well, which later becomes essential for weather and other messages.

::blog-image
---
imagePath: /img/ppbc/layout visualizer-02.jpg
width: 640px
---
::
...
::blog-image
---
imagePath: /img/ppbc/layout visualizer-03.jpg
width: 640px
---
::
...
::blog-image
---
imagePath: /img/ppbc/layout visualizer-04.jpg
caption: PPBC font designs.
width: 640px
---
::
...
::github-repo-card
---
repo: lancewilhelm/pingPongBallClock
---
...
The web application can be brought into the modern age with libraries like React and Vue. The trick is making it available for hosting via the flask python server. Other solutions are possible, but the simple setup of flask servers make them ideal for this use case.
